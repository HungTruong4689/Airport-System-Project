...
Error_code Runway_P5::can_land(const Plane_P5& current)
/*
...
Error_code Runway_P5::can_depart(const Plane_P5& current)
/*
Post:  If possible, the Plane current is added to the
...
Runway_activity Runway_P5::activity(int time, Plane_P5& moving)
/*
...
void Runway_P5::shut_down(int time) const
/*
